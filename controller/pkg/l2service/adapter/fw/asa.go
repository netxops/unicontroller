...
func (a Asa) Process(remote *structs.L2DeviceRemoteInfo, taskConfig structs.L2NodemapTaskConfigInterface, options ...interface{}) (result *clitask.Table, err error) {
...
func (a Asa) config(remote *structs.L2DeviceRemoteInfo, taskConfig structs.L2NodemapTaskConfigInterface, options ...interface{}) (*clitask.Table, error) {
	cmds := []string{}
	...
	return terminalConfig(terminalmode.ASA, remote, taskConfig, cmds)
}

func terminalConfig(deviceType terminalmode.DeviceType, remote *structs.L2DeviceRemoteInfo, taskConfig structs.L2NodemapTaskConfigInterface, params []string) (result *clitask.Table, err error) {
	...
	fmt.Println("method params======>", params)
	...
	if err != nil {
		err = errors.New("config result trans err")
		return
	}
