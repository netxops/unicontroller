...
func (a SecPath) Process(remote *structs.L2DeviceRemoteInfo, taskConfig structs.L2NodemapTaskConfigInterface, options ...interface{}) (result *clitask.Table, err error) {
...
func (a SecPath) config(remote *structs.L2DeviceRemoteInfo, taskConfig structs.L2NodemapTaskConfigInterface, options ...interface{}) (*clitask.Table, error) {
	cmds := []string{}
	...
	if len(cmds) == 0 {
		return nil, errors.New("secpath commands not received, command is empty")
	}
	return terminalConfig(terminalmode.SecPath, remote, taskConfig, cmds)
}

//
//func config(deviceType terminalmode.DeviceType, remote *structs.L2DeviceRemoteInfo, taskConfig structs.L2NodemapTaskConfigInterface, params []string) (result *clitask.Table, err error) {
...
//
//	fmt.Println("asa method params======>", params)
...
//	if err != nil {
//		err = errors.New("asa config result trans err")
//		return
//	}
//
